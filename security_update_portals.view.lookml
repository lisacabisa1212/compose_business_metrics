- view: security_update_portals
  sql_table_name: segment.security_update_portals
  fields:
  ...
  - dimension: portal_1012
    type: string
    sql: ${TABLE}.portal_1012

  - dimension: portal_2143
    type: string
    sql: ${TABLE}.portal_2143

  - dimension: portal_regex
    type: string
    sql: ${TABLE}.portal_regex
